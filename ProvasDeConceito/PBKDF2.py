...
# Definir a palavra-passe (neste caso, simula o vosso código aleatório)
codigo_aleatorio = b"meu_codigo_secreto_123"

# Gerar um salt aleatório (deve ser guardado para derivar a mesma chave mais tarde)
salt = os.urandom(16)

# Configurar o PBKDF2 para gerar uma chave de 256 bits (32 bytes)
kdf = PBKDF2HMAC(
